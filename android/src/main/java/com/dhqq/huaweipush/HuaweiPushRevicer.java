...
public class HuaweiPushRevicer extends PushReceiver {
    ...
    public static final String ACTION_PUSHMSG = "action.gotPushMSG";
    public static final String ACTION_GOTCLICK = "action.gotClick";
...
//        callBack(intent);
    ...
    public boolean onPushMsg(Context context, byte[] msg, Bundle bundle) {
        try {
            ...
            Intent intent = new Intent();
            intent.setAction(ACTION_PUSHMSG);
...
//            intent.putExtra("log", "Receive push pass message, exception:" + e.getMessage());
    ...
    public void onEvent(Context context, Event event, Bundle extras) {
        Intent intent = new Intent();
        intent.setAction(ACTION_GOTCLICK);
